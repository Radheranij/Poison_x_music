...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("Krishna_Help")
                await self.two.join_chat("official_radhe_krishna_1")
                await self.two.join_chat("Poison_BotUpdates")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("Krishna_Help")
                await self.three.join_chat("official_radhe_krishna_1")
                await self.three.join_chat("Poison_BotUpdates")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("Krishna_Help")
                await self.four.join_chat("official_radhe_krishna_1")
                await self.four.join_chat("Poison_BotUpdates")
            except:
                pass
            assistants.append(4)
            try:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("Krishna_Help")
                await self.five.join_chat("official_radhe_krishna_1")
                await self.five.join_chat("Poison_BotUpdates")
            except:
                pass
            assistants.append(5)
            try:
